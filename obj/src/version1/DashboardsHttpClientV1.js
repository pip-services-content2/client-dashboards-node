...
exports.DashboardsHttpClientV1 = void 0;
const pip_services3_commons_nodex_1 = require("pip-services3-commons-nodex");
const pip_services3_rpc_nodex_1 = require("pip-services3-rpc-nodex");
class DashboardsHttpClientV1 extends pip_services3_rpc_nodex_1.CommandableHttpClient {
    constructor(config) {
        super('v1/dashboards');
        if (config != null)
    ...
    setDashboard(correlationId, dashboard) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.callCommand('set_dashboard', correlationId, {
                    dashboard: dashboard,
                });
            }
            catch (err) {
